...
public class PathTest01 {
    public static void main(String[] args) {
        ...
        System.out.println(p1.getFileName().toFile().lastModified());
        System.out.println(p2.getFileName().toFile().lastModified());
        System.out.println(p3.getFileName().toFile().lastModified());
        System.out.println(p4.getFileName().toFile().lastModified());
    }
}
